...
module.exports = class VOID {
  ...
  serverCount(message) {
  fetch(`https://usure.one/api/bots/stats`, {
        method: 'POST',
        headers: { 
  ...
  async search(id) {
  return await fetch(`https://usure.one/api/bots/${id}`, {
        method: 'GET'
    })
  ...
  async hasVoted(id) {
  return await fetch(`https://usure.one/api/bots/check/${id}`, {method: 'GET',headers: { 
